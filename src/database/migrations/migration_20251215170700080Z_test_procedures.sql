...
-- ====================================================================
-- ============================== Save Employee ==============================
CREATE OR ALTER PROCEDURE sp_DashboardLogin_test
...
-- ===========================================================================
-- ============================== Get Step User ==============================
CREATE OR ALTER PROCEDURE sp_UserGetSteps_test
  @username NVARCHAR(MAX)
AS 
BEGIN
  SET NOCOUNT ON;
...
-- ===========================================================================
-- ============================== Get Step User ==============================
CREATE OR ALTER PROCEDURE sp_UserValidateAuthorizationCode_test
  @username NVARCHAR(MAX)
AS
BEGIN
  SET NOCOUNT ON;
...
-- ===========================================================================
-- ============================ Get Password User ============================
CREATE OR ALTER PROCEDURE sp_UserGetPassword_test
  @username NVARCHAR(MAX)
AS 
BEGIN
  SET NOCOUNT ON;
...
CREATE OR ALTER PROCEDURE sp_UserChangePassword_test
  @username NVARCHAR(MAX),
...
BEGIN 
  ...
  BEGIN TRY
    ...
    IF NOT EXISTS (SELECT 1 FROM Users_test WHERE Username = @username)
...
-- ===========================================================================
-- ============================= Get All Company =============================
CREATE OR ALTER PROCEDURE sp_CompanyGetAll_test
AS 
BEGIN 
  SET NOCOUNT ON;
...
-- ===========================================================================
-- =========================== Get Company by ID =============================
CREATE OR ALTER PROCEDURE sp_CompanyGetById_test
  @name NVARCHAR(MAX)
AS 
BEGIN 
  SET NOCOUNT ON;
...
-- ===========================================================================
-- ============================= Create Company ==============================
CREATE OR ALTER PROCEDURE sp_CompanyCreate_test
  @name NVARCHAR(MAX),
...
BEGIN 
  ...
  BEGIN TRY
    ...
    -- Verificar si el empleado existe
        IF EXISTS (SELECT 1 FROM Companies_test WHERE Name = @name)
        BEGIN
            -- Si existe, actualizar
            UPDATE Companies_test
            SET 
                Name = @name,
                ShortName = @shorName,
