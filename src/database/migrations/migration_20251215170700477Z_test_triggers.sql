...
-- Descripción: Inserta automáticamente en Payments_test cuando se agrega 
--              un registro en BitacoraPayments_test para un empleado existente
-- =============================================
CREATE OR ALTER TRIGGER trg_SyncPaymentFromBitacora_test
ON BitacoraPayments_test
AFTER INSERT
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            SELECT 
                ...
                e.ID_EMPLOYEE
            FROM inserted i
            INNER JOIN Employees_test e ON i.CodEmployee = e.CodEmployee
